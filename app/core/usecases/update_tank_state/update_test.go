...
// func (tank *waterTankUpdateMockData) GetWaterTankState(ctx context.Context, connection water_tank.IConn, input *water_tank.GetWaterTankState) (state *water_tank.WaterTank, err stack.Error) {
// 	state = tank.states[group][names[0]]
// 	return
// }

// func (tank *waterTankUpdateMockData) GetTankGroupState(ctx context.Context, connection water_tank.IConn, input *water_tank.GetGroupTanks) (state []*water_tank.WaterTank, err stack.Error) {
...
// func (tank *waterTankUpdateMockData) CreateWaterTank(ctx context.Context, connection water_tank.IConn, input *water_tank.CreateInput) (tankState *water_tank.WaterTank, err stack.Error) {
...
// func (tank *waterTankUpdateMockData) UpdateTankWaterLevel(ctx context.Context, connection water_tank.IConn, input *water_tank.UpdateWaterLevelInput) (state *water_tank.WaterTank, err stack.Error) {
