...
import (
	...
	"water-tank-api/core/usecases/get/group"
	"water-tank-api/core/usecases/get/tank"
	"water-tank-api/core/usecases/register_tank"
...
func Test_Controller_Create(t *testing.T) {
	...
	Test_Controller_InvalidRequest_Create := func(t *testing.T) {
		t.Run("Invalid request create", func(t *testing.T) {
			expectedReturn := NewControllerError(WaterTankInvalidRequest, register_tank.WaterTankMaximumCapacityZero.Error())
	...
	Test_Controller_InternalError_Create := func(t *testing.T) {
		t.Run("Internal error create", func(t *testing.T) {
			expectedReturn := NewControllerError(WaterTankInternalServerError, tank.WaterTankErrorServerError(errors.New("ERROR").Error()).Error())
...
func Test_Controller_Update(t *testing.T) {
	...
	Test_Controller_NotFound_Update := func(t *testing.T) {
		t.Run("Invalid request update", func(t *testing.T) {
			expectedReturn := NewControllerError(WaterTankNotFound, update_tank_state.WaterTankErrorNotFound("TANK_1vSND3").Error())
	...
	Test_Controller_InvalidRequest_Update := func(t *testing.T) {
		t.Run("Invalid request update", func(t *testing.T) {
			expectedReturn := NewControllerError(WaterTankInvalidRequest, update_tank_state.WaterTankCurrentWaterLevelSmallerThanZero.Error())
...
func Test_Controller_Get(t *testing.T) {
	...
	Test_Controller_Successful_Get := func(t *testing.T) {
		t.Run("Successful get", func(t *testing.T) {
			expectedReturn := NewControllerResponse(WaterTankOK, &get.WaterTankState{
				Name:              "TANK_1",
				Group:             "GROUP_1",
	...
	Test_Controller_NotFound_Get := func(t *testing.T) {
		t.Run("Not found get", func(t *testing.T) {
			expectedReturn := NewControllerError(WaterTankNotFound, tank.WaterTankErrorNotFound("TANK_1sdvW4").Error())
...
func Test_Controller_GetGroup(t *testing.T) {
	...
	Test_Controller_NotFound_GetGroup := func(t *testing.T) {
		t.Run("Not found get group", func(t *testing.T) {
			expectedReturn := NewControllerError(WaterTankNotFound, group.WaterTankErrorGroupNotFound("GROUP_1sdvW4").Error())
	...
	Test_Controller_InternalError_GetGroup := func(t *testing.T) {
		t.Run("Internal error get group", func(t *testing.T) {
			expectedReturn := NewControllerError(WaterTankInternalServerError, group.WaterTankErrorServerError(errors.New("ERROR").Error()).Error())
